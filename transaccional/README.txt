...
a persistence unit "transaccionalPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "transaccional\pom.xml":
...
artifact ("transaccional.war") is already built. You can build
